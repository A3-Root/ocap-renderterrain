 ...
 *
 * Example:
 * _this call ocap_renderterrain_fnc_createMapItem;
 *
 * Public: No
 */
...
private _grp = _display ctrlCreate ['ocap_renderterrain_mapItem', -1, _parentGrp];
...
_grp setVariable ["ocap_renderterrain_worldName", _worldName];

if (_selected) then { (_grp controlsGroupCtrl IDC_MAPITEM_NAME) call (uiNamespace getVariable "ocap_renderterrain_fnc_mapItem_onClick"); };
