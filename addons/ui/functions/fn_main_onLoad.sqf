 ...
 *
 * Example:
 * _this call ocap_renderterrain_fnc_onLoad;
 *
 * Public: No
 */
...
private _selectedMaps = uiNamespace getVariable ["ocap_renderterrain_selectedMaps", []];
...

{
	...
	private _item = [
		...
		_author,
		_selected
	] call (uiNamespace getVariable "ocap_renderterrain_fnc_mapItem_create");
