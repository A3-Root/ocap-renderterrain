 ...
 *
 * Example:
 * _this call ocap_renderterrain_fnc_mapItem_onClick;
 *
 * Public: No
 */
...
private _selected = _grp getVariable ['ocap_renderterrain_selected', false];
_grp setVariable ['ocap_renderterrain_selected', !_selected];
